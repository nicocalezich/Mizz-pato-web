...
<section>
   <section id="section-1" class="row">  
        <div id="section-1-div" class="col-sm-12">
            <div id="section-1-div-info">
                ...
                <div id="section-1-link-socialmedia">
                    ...
                    <a :href="instagramLink" target="_blank"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
                    ...
                    <a :href="twitterLink" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
...
@import url('https://fonts.googleapis.com/css2?family=Indie+Flower&display=swap');
  ...
  *, *:before, *:after{
    ...
    #section-1-link-mixcloud:hover{
        background-color: #e6aba5;  
        transition: .4s;
    }

    #section-1-link-socialmedia{
        margin-top: 25px;
        margin-left: 585px;
    }

    #section-1-link-socialmedia a{
        color: black;
        padding: 5px;
        font-size: 20px;
    }
    ...
    #section-2-col-2-img{
        ...
        height: 550px;
        margin-top: 50px;     
        box-shadow: 10px 0px 10px rgba(0,0,0,.6);
    }
